...
public :
  ...
  // std::map<std::pair<int, int>, float> my_calib_map;
   ...
   // Niramay. defining new variables
   Float_t         ahc_energySum;
   vector<float>* ahc_energyPerLayer; // rechit per layer - AH
...
/* void HGCNtupleVariables::Init(TTree *tree) */
{
  ...
  /* energyAbsorbedFH = 0; */
   ...
   // Niramay. filling the new branches
